            ...
            props.usersPage.map(u => <div key={u.id}>
                <span>
                    <div><NavLink to={'/profile/'+u.id}>
                        <img src={u.photos.small != null ? u.photos.small : userPhoto} alt='UserPhoto' className={s.userImg}/>
                    </NavLink>
                    </div>
                    <div>{u.followed ? <button onClick={() => {
                        axios.delete<APIType>(`https://social-network.samuraijs.com/api/1.0/follow/${u.id}`,{withCredentials:true,
                        headers:{
                        ...
                        <button onClick={() => {
                            axios.post<APIType>(`https://social-network.samuraijs.com/api/1.0/follow/${u.id}`,{},{withCredentials:true,
                                headers:{
                                    'API-KEY':'13158516-512e-4eb5-8351-d4d4ecf9c6e7'
                                }})
                                .then(response => {
